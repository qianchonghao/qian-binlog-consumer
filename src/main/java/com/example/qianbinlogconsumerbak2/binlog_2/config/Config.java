...
package com.example.qianbinlogconsumerbak2.binlog_2.config;
...
//        InputStream in = Config.class.getClassLoader().getResourceAsStream("application.yml");
    ...
    @ClassInfo(className = "com.example.qianbinlogconsumerbak2.binlog_2.config.SubscribeInfo",type = ClassInfo.ARRAY)
